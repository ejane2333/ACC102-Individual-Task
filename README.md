...
> **Note:** If `streamlit run app.py` does not work, use `python -m streamlit run app.py` instead. This is the recommended command if Streamlit is not added to your system PATH.
